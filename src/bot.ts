  ...
  app.on(
    ...
    async (context) => {
      ...
      if (context.payload.action === 'synchronize' && commits.length >= 2) {
        ...
        console.time('ignorePatterns:' + JSON.stringify(ignorePatterns));
        console.time('filesNames:' + JSON.stringify(filesNames));
        console.time('changedFiles:' + JSON.stringify(changedFiles));
        ...
        console.time('changedFiles2:' + JSON.stringify(changedFiles));
      }
